...
import com.czl.api.core.http.HttpClient
import com.czl.api.core.http.HttpMethod
import com.czl.api.core.http.HttpRequest
import com.czl.api.core.http.HttpRequestBody
import com.czl.api.core.http.HttpResponse
import com.czl.api.errors.CzlIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw CzlIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(CzlIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("CZL_LOG")?.lowercase()) {
