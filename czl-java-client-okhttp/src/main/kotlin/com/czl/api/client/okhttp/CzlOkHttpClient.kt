...
import com.czl.api.client.CzlClientImpl
...
class CzlOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [CzlOkHttpClient]. */
        @JvmStatic fun builder() = Builder()

        @JvmStatic fun fromEnv(): CzlClient = builder().fromEnv().build()
    }

    /** A builder for [CzlOkHttpClient]. */
