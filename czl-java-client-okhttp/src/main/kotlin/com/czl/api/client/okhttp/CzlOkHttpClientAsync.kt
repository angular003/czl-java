...
package com.czl.api.client.okhttp

import com.czl.api.client.CzlClientAsync
import com.czl.api.client.CzlClientAsyncImpl
import com.czl.api.core.ClientOptions
import com.czl.api.core.Timeout
...
class CzlOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [CzlOkHttpClientAsync]. */
        @JvmStatic fun builder() = Builder()

        @JvmStatic fun fromEnv(): CzlClientAsync = builder().fromEnv().build()
    }

    /** A builder for [CzlOkHttpClientAsync]. */
